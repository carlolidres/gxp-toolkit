-- Inbox/workspace Due used step.due_at only. Create flow stores the user-facing
-- due date on edoc_documents.due_at and leaves step.due_at null, so the panel
-- showed "Not set". Prefer step override, else document due.
